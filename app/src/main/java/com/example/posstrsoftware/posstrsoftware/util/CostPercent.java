...
public class CostPercent {
    ...
    public static double parserFormat(Double input){
        ...
        Log.d("inputx=",x+"");
        return Double.parseDouble(isCheck(0,0,decimal1)?cal[0]+".00":isCheck(1,25,decimal1)?cal[0]+".25":isCheck(26,50,decimal1)?cal[0]+".50":isCheck(51,75,decimal1)?cal[0]+".75":isCheck(76,99,decimal1)?calx:".00");
    }
